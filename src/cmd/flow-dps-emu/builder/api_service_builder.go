...
func NewFlowDPSEmulatorBuilder() *FlowDPSEmulatorBuilder {
	return &FlowDPSEmulatorBuilder{
...
type FlowDPSEmulatorBuilder struct {
	*service.FlowServiceBuilder
	...
	Api                     *proxy.DPSService
	RpcEngine               *engine.RPC
}

// Initialize Parse and print API Service command line arguments.
func (fsb *FlowDPSEmulatorBuilder) Initialize() error {
...
func (fsb *FlowDPSEmulatorBuilder) Build() (*FlowAPIServiceCmd, error) {
...
func (fsb *FlowDPSEmulatorBuilder) BootstrapIdentities(addresses []string, keys []string) (flow.IdentityList, error) {
